...
const SKIP_LABELS: Partial<Record<AutoTradeSkipCode, string>> = {
  ...
  panic_stop_active: "Emergency stop active",
  auto_trading_disabled: "Auto Trading is off",
  execution_disabled: "Paper execution is off",
  runtime_disabled: "New entries paused — resume engine",
  live_endpoint: "Live endpoint blocked",
  market_closed: "Regular market is closed",
  market_status_unavailable: "Market status unavailable",
  ...
  not_ready: "Setup not fully eligible yet",
